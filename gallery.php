    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a href="?page=<?php echo $page - 1; ?>" class="Button2">Poprzednia</a>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <a href="?page=<?php echo $i; ?>" <?php if ($i == $page)
                           echo ' class="Button2Active" '; ?>
                        class="Button2"><?php echo $i; ?></a>
                <?php endfor; ?>
                <?php if ($page < $total_pages): ?>
                    <a href="?page=<?php echo $page + 1; ?>" class="Button2">Następna</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        <a href="dashboard.php" class="Button1">Powrót do menu głównego</a>
